...
# ------------------------------------------------------------------------------------------------------------------------------|
OPENCV_VERSION='4.5.3'       	# version para ser instalada de OpenCV
...
GCC_VERSION='gcc-9'		# versión do compilador c/c++ (>>gcc -v ou gcc --version)
CUDA_VERSION= '11.1'
ARCH_BIN='7.5'			# Capacidade computacional da tua NVIDIA.
				# Podes atopar este dato aqui: https://developer.nvidia.com/cuda-gpus#compute
# ---------------------------------------------------------------------------------------------------------------------------- |
