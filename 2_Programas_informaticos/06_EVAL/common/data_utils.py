...
def preprocess_image(image, model_input_shape, is_letterbox=False):
    """
    ...
    """
    image_data = cv2.resize(image, model_input_shape[::-1], cv2.INTER_AREA)
    ...
    #     resized_image = image.resize(model_input_shape[::-1], Image.LINEAR)
