...
import numpy as np
from common.yolo_postprocess_np import yolo_decode, yolo_handle_predictions, yolo_correct_boxes, yolo_adjust_boxes, yolov4_handle_predictions
...
def yolo3_postprocess_np(yolo_outputs, image_shape, anchors, num_classes, model_input_shape, max_boxes=300, confidence=0.1, iou_threshold=0.4, elim_grid_sense=False):
    ...
    boxes, classes, scores = yolov4_handle_predictions(predictions,
                                                     image_shape,
                                                     num_classes,
                                                     max_boxes=max_boxes,
