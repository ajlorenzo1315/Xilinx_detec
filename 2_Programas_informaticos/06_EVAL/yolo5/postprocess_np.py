...
def yolo5_postprocess_np(yolo_outputs, image_shape, anchors, num_classes, model_input_shape, max_boxes=300, confidence=0.1, iou_threshold=0.4, elim_grid_sense=True):
